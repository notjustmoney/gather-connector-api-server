...
song_request_router.register(r'playlist/songs', SongRequestViewSet)
song_request_router = routers.NestedDefaultRouter(song_request_router, r'playlist/songs', lookup='playlist_song')
song_request_router.register(r'comments', SongRequestCommentViewSet, basename='playlist-song-comments')
